...
این قسمت برای اعتبارسنجی داده ها های دانشجو است که با استفاده از عبارت منظم شرایط مختلف، صحت داده هارا بررسی میکند. مثلا کدپستی باید عددی 10 رقمی باشد یا شهر محل تولد باید یکی از شهرهای مشخص شده باشد و...
